...
While it may require a vote, concerns brought up within a reasonable window should be addressed. Concerns which come up after a policy has already been decided on may lead to a revision if deemed necessary.
...
Veto holders must explicitly state using such power when intended,
